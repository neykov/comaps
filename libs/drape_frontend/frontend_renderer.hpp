...
struct TapInfo
{
  ...
  // Enlarged tap rectangle for thin track lines, so that they are easier to hit with a finger.
  static m2::AnyRectD GetTrackTapRect(m2::PointD const & mercator, ScreenBase const & screen);
